...
<div>
    <app-content id="register">
        ...
        <form action="" class="loginForm">
            ...
            <label>
                <input type="password" ref="pwd" class="inp" placeholder="请输入验证码">
                <p class="verification-code"  @click="getCode()"><span>获取验证码</span>
                <i ref="timeNum">30</i></p>  
            </label>
            <button class="loginBtn" id="registerBtn">注&nbsp;册</button>
            
        </form>
        <p class="tips">登录则代表你已阅读并同意<a>《微趣使用条款》</a></p>
        </div>
    </app-content>  
</div>
</template>
...
<style scoped>
#register{width:100%;height:100%;background:#f5f5f5;position:absolute;top:0;bottom:0; z-index: 4;}
.loginBox{height:100%;padding-bottom:1.2rem;}
