	    ...
	    <li class="item">
	        <div class="top">
	            <div class="head-img-wrap">
	                ...
	                <div class="top-middle">
	                	...
	                	<slot name="time"></slot>
	                    <!-- <p class="title" slot="title">微趣小可爱</p>
	                    <p class="time" slot="time">2018.03.02</p> -->
	                </div>
	            </div>
	            <div class="tab-wrap">
                ...
                <slot name="focus-btn"></slot>
		            ...
		            <!-- <div class="arrow-wrap" @click="tabAct" slot="arrow-wrap">
	        ...
	        <ul class="btn-list">
                ...
                <span class="img" slot="img-icon1">
	                ...
	                <!-- <span class="btn-text" slot="btn-text1">520</span> -->
	            ...
	            <li class="btn-item">
	                <span class="img" @click="addLikeAct">
...
<script type="text/javascript">
  import {addLikeData} from "../../services/homeService.js";
	export default {
		name: "user-item",
    props: ["topicId"],
    data () {
    ...
    methods: {
      addLikeAct () {
        addLikeData(this.topicId).then(data=>{
